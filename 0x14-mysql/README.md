...
## let refresh our mines with Database administration
...
![signature.key](https://dev.mysql.com/doc/refman/5.7/en/checking-gpg-signature.html)

Save it in a file on your machine i.e. signature.key .. scroll down.
...
## how to run bash file for it :page_with_curl:
